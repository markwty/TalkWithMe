...
public class ChatSensorsMove extends Fragment {
    private FragmentActivity activity;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.chat_sensors_move, container, false);
        ...
        final Button SensorsButton = view.findViewById(R.id.SensorsButton);
